...
public class SQLiteDBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase arg0) {
		...
		arg0.execSQL("insert into reserveRecord(roomname,username,useBegin,useEnd,state ,description ,reservetime) " +
				"values('会议室553','大鹏哥','2015-11-21 08:00:00' ,'2015-11-21 15:00:00' ,'已审核' ,'周二例会' ,'2015-11-20 15:55:01')");
		arg0.execSQL("insert into reserveRecord(roomname,username,useBegin,useEnd,state ,description ,reservetime) " +
				"values('会议室448','张三','2015-11-27 10:00:00' ,'2015-11-27 12:00:00' ,'已审核' ,'中科院山世光老师' ,'2015-11-20 21:42:23')");
		arg0.execSQL("insert into reserveRecord(roomname,username,useBegin,useEnd,state ,description ,reservetime) " +
				"values('会议室523','李四','2015-12-01 08:00:00' ,'2015-12-01 12:00:00' ,'未审核' ,'周二例会' ,'2015-11-23 09:54:51')");
		arg0.execSQL("insert into reserveRecord(roomname,username,useBegin,useEnd,state ,description ,reservetime) " +
				"values('会议室545','王五','2015-12-04 09:00:00' ,'2015-12-04 12:00:00' ,'已审核' ,'学位分委员会' ,'2015-11-27 15:22:01')");
		arg0.execSQL("insert into reserveRecord(roomname,username,useBegin,useEnd,state ,description ,reservetime) " +
				"values('会议室553','敖广','2015-11-27 19:00:00' ,'2015-11-27 22:00:00' ,'未审核' ,'组会' ,'2015-11-27 18:02:21')");
